...
The resulting object is now ready to be used to perform interpolation on a set of target locations (see next section). Interpolation parameters are also stored in the same object (do not worry if you do not understand their meaning at this point):
```{r}
