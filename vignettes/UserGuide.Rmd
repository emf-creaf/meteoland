...
meteoplot(mp, 1, "Precipitation", ylab="Precipitation (mm)", xlab="")
title("Original")
meteoplot(y, 1, "Precipitation", ylab="Precipitation (mm)", xlab="")
title("Synthetic")
```
