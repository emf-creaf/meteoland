...
Note that we specified a CRS projection (parameter `proj4string`) to UTM28N. This is because interpolation should be preferably conducted on a projected coordinate reference system with easting and northing in meters.
