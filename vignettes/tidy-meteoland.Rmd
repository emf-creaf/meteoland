...
For interpolating meteorological information we need mainly two things:
  ...
  1. The **topographical information** of the locations to interpolate. This includes elevation,
...
the only thing to consider is ensuring that the topographical variables has the mandatory names
...
```
  ...
  interpolator object. If the topography information is in an sf object, as in the example,
...
We can use `interpolate_data` in a raster type of data. All we need is the topography information
